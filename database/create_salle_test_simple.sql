-- Creation d'une salle de test pour rating
...
INSERT INTO salles (
    ...
    999,
    'Salle Test Rating',
    'Salle de test specialement concue pour tester le systeme de notation/rating',
    50,
    200,
    99.99,
...
INSERT INTO gym_subscription_offers (
    ...
    (999, 'Essai Mensuel', 29.99, 'Acces complet a la salle test', 1, '{"wifi": true, "parking": true, "douche": true}', 'active', NOW(), NOW()),
    (999, 'Essai Annuel', 299.99, 'Acces complet + reductions exclusives', 12, '{"wifi": true, "parking": true, "douche": true, "locker": true}', 'active', NOW(), NOW()),
    (999, 'Essai Premium', 499.99, 'Acces VIP + coaching perso', 6, '{"wifi": true, "parking": true, "douche": true, "locker": true, "coaching": true}', 'active', NOW(), NOW());
...
INSERT INTO ratings_salle (
    ...
    (999, 1, 5, 'Salle excellente ! Tres propre et bien equipee.', DATE(NOW() - INTERVAL 7 DAY), 'approuve', NOW(), NOW()),
    (999, 2, 4, 'Bonne salle, mais pourrait etre amelioree.', DATE(NOW() - INTERVAL 5 DAY), 'approuve', NOW(), NOW()),
    (999, 3, 3, 'Correct mais un peu cher pour ce qu''elle offre.', DATE(NOW() - INTERVAL 3 DAY), 'approuve', NOW(), NOW()),
    (999, 4, 4, 'Tres satisfait de l''equipement et du service.', DATE(NOW() - INTERVAL 1 DAY), 'approuve', NOW(), NOW()),
    (999, 5, 2, 'Salle propre, bien localisee.', DATE(NOW() - INTERVAL 2 DAY), 'approuve', NOW(), NOW());

-- Verification de la creation
SELECT 
    'Salle de test creee avec succes' as status,
